...
def auth_client(user):
    def api_client(user_instance=None):
        if user_instance is None:
            ...
            login_response = client.post('/authentication/login/', dict(username="asdfasdf", password="asdfasdF1!"))
            ...
            login_response = client.post('/authentication/login/', dict(username=user_instance["username"], password=user_instance["password"]))
